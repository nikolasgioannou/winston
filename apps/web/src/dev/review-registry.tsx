...
import { TaskDetailPreview } from "./task-detail-preview";
...
export const reviewPages: readonly ReviewPage[] = [
  {
    ...
    states: [
      ...
      ...(
        ...
        label: state,
        fullWidth: true,
        render: () => <TaskDetailPreview initial={state} />,
      })),
    ],
  },
  {
    ...
    states: [
      {
        ...
        label: "Ready",
        fullWidth: true,
        render: () => <ResponsibilityDetailPreview initial="ready" />,
      },
      ...(
        [
          "editing",
        ...
        label: state,
        fullWidth: true,
        render: () => <ResponsibilityDetailPreview initial={state} />,
      })),
    ],
  },
  {
    ...
    states: [
      {
        ...
        label: "Ready",
        fullWidth: true,
        render: () => <ScheduleEditorPreview initial="ready" />,
      },
      ...(["paused", "canceled", "saving", "conflict", "loading", "error"] as const).map(
        (state) => ({
          id: state,
          label: state,
          fullWidth: true,
